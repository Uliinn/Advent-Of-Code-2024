# Now 3 leaves in recursion instead of 2. Still same recursion depth
...
def recursive_check_possible(goal,current_sum,nums,nums_idx) -> bool:
  ...
  # concatinate
  concatination = int(str(current_sum) + str(nums[nums_idx])) # This is expensive, could surely be optimized
  if recursive_check_possible(goal,concatination,nums,nums_idx+1):
    return True
